...
# Set PATIENT_DATA_BASE_DIR to the folder path where patient's (clinical and genomic) JSON files will be present.
...
# Set TRIAL_DATA_BASE_DIR to the folder path where trial JSON files will be present.
